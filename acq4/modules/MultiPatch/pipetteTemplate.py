...
class Ui_PipetteControl(object):
    def setupUi(self, PipetteControl):
        ...
        PipetteControl.resize(1004, 133)
        ...
        self.fouledCheck = QtGui.QCheckBox(self.widget_2)
        self.fouledCheck.setObjectName(_fromUtf8("fouledCheck"))
        self.verticalLayout_2.addWidget(self.fouledCheck)
        ...
        self.brokenCheck = QtGui.QCheckBox(self.widget_3)
        self.brokenCheck.setObjectName(_fromUtf8("brokenCheck"))
        self.verticalLayout_3.addWidget(self.brokenCheck)
        ...
        self.newPipetteBtn = QtGui.QPushButton(self.widget)
        self.newPipetteBtn.setObjectName(_fromUtf8("newPipetteBtn"))
        self.verticalLayout.addWidget(self.newPipetteBtn)
        ...
        self.gridLayout.addWidget(self.plotLayoutWidget, 0, 6, 2, 1)
    ...
    def retranslateUi(self, PipetteControl):
        ...
        self.fouledCheck.setText(_translate("PipetteControl", "fouled", None))
        self.autoBiasBtn.setText(_translate("PipetteControl", "bias: off", None))
        self.brokenCheck.setText(_translate("PipetteControl", "broken", None))
        ...
        self.newPipetteBtn.setText(_translate("PipetteControl", "new pip.", None))
