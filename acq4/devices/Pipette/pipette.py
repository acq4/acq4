...
class Pipette(Device, OptomechDevice):
    ...
    * reasonable tip offset distance: the maximum distance (in meters) from the original tip offset that is
        considered reasonable. If the tip offset is outside this distance, the user will be prompted to
        confirm the new offset. Default is 30 um.
    """
