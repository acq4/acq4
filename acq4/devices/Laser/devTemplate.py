...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.qSwitchBtn, 2, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.energyCalcGroup, 0, 6, 3, 1)
        ...
        self.gridLayout_9 = QtGui.QGridLayout(self.subPowerGroup)
        ...
        self.label_15 = QtGui.QLabel(self.powerGroup)
        ...
        self.gridLayout.addWidget(self.powerGroup, 4, 0, 1, 5)
        self.turnOnOffBtn = QtGui.QPushButton(Form)
        ...
        self.gridLayout.addWidget(self.turnOnOffBtn, 2, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.wavelengthSpin, 0, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.wavelengthCombo, 0, 3, 1, 1)
        self.currentWaveLengthLabel = QtGui.QLabel(self.wavelengthGroup)
        self.currentWaveLengthLabel.setText(_fromUtf8(""))
        self.currentWaveLengthLabel.setObjectName(_fromUtf8("currentWaveLengthLabel"))
        self.gridLayout_5.addWidget(self.currentWaveLengthLabel, 1, 2, 1, 1)
        self.label_2 = QtGui.QLabel(self.wavelengthGroup)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.gridLayout_5.addWidget(self.label_2, 1, 0, 1, 1)
        self.gridLayout.addWidget(self.wavelengthGroup, 5, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.groupBox_2, 7, 0, 1, 5)
        ...
        self.GDDGroup = QtGui.QGroupBox(Form)
        self.GDDGroup.setObjectName(_fromUtf8("GDDGroup"))
        self.gridLayout_10 = QtGui.QGridLayout(self.GDDGroup)
        self.gridLayout_10.setObjectName(_fromUtf8("gridLayout_10"))
        self.GDDSpin = QtGui.QSpinBox(self.GDDGroup)
        self.GDDSpin.setMaximum(32000)
        self.GDDSpin.setObjectName(_fromUtf8("GDDSpin"))
        self.gridLayout_10.addWidget(self.GDDSpin, 0, 1, 1, 1)
        self.GDDEnableCheck = QtGui.QCheckBox(self.GDDGroup)
        self.GDDEnableCheck.setObjectName(_fromUtf8("GDDEnableCheck"))
        self.gridLayout_10.addWidget(self.GDDEnableCheck, 0, 0, 1, 1)
        self.GDDLimits = QtGui.QLabel(self.GDDGroup)
        self.GDDLimits.setObjectName(_fromUtf8("GDDLimits"))
        self.gridLayout_10.addWidget(self.GDDLimits, 0, 2, 1, 1)
        self.gridLayout.addWidget(self.GDDGroup, 6, 0, 1, 5)
        ...
        self.label_13 = QtGui.QLabel(self.MaiTaiGroup)
        ...
        self.EmissionLabel.setText(_fromUtf8(""))
        self.EmissionLabel.setObjectName(_fromUtf8("EmissionLabel"))
        self.gridLayout_11.addWidget(self.EmissionLabel, 0, 1, 1, 1)
        self.PulsingLabel = QtGui.QLabel(self.MaiTaiGroup)
        self.PulsingLabel.setText(_fromUtf8(""))
        self.PulsingLabel.setObjectName(_fromUtf8("PulsingLabel"))
        self.gridLayout_11.addWidget(self.PulsingLabel, 1, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.relHumidityLabel, 2, 1, 1, 1)
        self.gridLayout.addWidget(self.MaiTaiGroup, 3, 0, 1, 5)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_15.setText(_translate("Form", "Current Pump Power:", None))
        self.turnOnOffBtn.setText(_translate("Form", "Turn Laser On", None))
        self.label_7.setText(_translate("Form", "Set Wavelength: ", None))
        ...
        self.label_13.setText(_translate("Form", "Pulsing:", None))
        self.label_6.setText(_translate("Form", "Emission:", None))
