...
class ScannerDeviceGui(Qt.QWidget):
    ...
    def sample(self):
        ...
        background = camera.acquireFrames(1, blocking=True, withBasicCameraControl=True)[0]
        ...
        try:
            ...
            for i in range(n):
                for j in range(n):
                    ...
                    images.append(camera.acquireFrames(1, blocking=True, withBasicCameraControl=True)[0])
        finally:
            laser.closeShutter()
