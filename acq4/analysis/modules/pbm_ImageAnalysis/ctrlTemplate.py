...
#
# Created: Sun Jul 27 09:39:11 2014
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ImagePhys_ImgNormalize.setGeometry(QtCore.QRect(0, 220, 91, 32))
        ...
        self.ImagePhys_NormInfo.setGeometry(QtCore.QRect(90, 225, 56, 16))
        ...
        self.ImagePhys_Update.setGeometry(QtCore.QRect(150, 185, 78, 32))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(5, 110, 101, 48))
        ...
        self.ImagePhys_ROIThrHigh = QtGui.QDoubleSpinBox(self.layoutWidget)
        ...
        self.ImagePhys_ROIThrLow = QtGui.QDoubleSpinBox(self.layoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(5, 185, 101, 26))
        ...
        self.ImagePhys_ROIKernel = QtGui.QComboBox(self.layoutWidget1)
        ...
        self.ImagePhys_findROIs.setGeometry(QtCore.QRect(0, 80, 106, 32))
        self.ImagePhys_findROIs.setObjectName(_fromUtf8("ImagePhys_findROIs"))
        self.layoutWidget2 = QtGui.QWidget(self.groupBox_3)
        self.layoutWidget2.setGeometry(QtCore.QRect(5, 160, 105, 25))
        ...
        self.ImagePhys_StdRB = QtGui.QRadioButton(self.layoutWidget2)
        self.ImagePhys_StdRB.setObjectName(_fromUtf8("ImagePhys_StdRB"))
        self.horizontalLayout_14.addWidget(self.ImagePhys_StdRB)
        self.ImagePhys_FFTRB = QtGui.QRadioButton(self.layoutWidget2)
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(5, 210, 101, 86))
        self.layoutWidget3.setObjectName(_fromUtf8("layoutWidget3"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.layoutWidget3)
        self.verticalLayout_2.setMargin(0)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.ImagePhys_RecalculateROIs = QtGui.QPushButton(self.layoutWidget3)
        ...
        self.ImagePhys_RetrieveROI = QtGui.QPushButton(self.layoutWidget3)
        ...
        self.ImagePhys_SaveROI = QtGui.QPushButton(self.layoutWidget3)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(5, 55, 96, 27))
        ...
        self.ImagePhys_ROISize = QtGui.QSpinBox(self.layoutWidget4)
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(150, 20, 126, 151))
        self.groupBox_4.setObjectName(_fromUtf8("groupBox_4"))
        self.layoutWidget5 = QtGui.QWidget(self.groupBox_4)
        self.layoutWidget5.setGeometry(QtCore.QRect(5, 20, 121, 120))
        self.layoutWidget5.setObjectName(_fromUtf8("layoutWidget5"))
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.layoutWidget5)
        self.verticalLayout_3.setMargin(0)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.ImagePhys_View = QtGui.QComboBox(self.layoutWidget5)
        ...
        self.ImagePhys_ImgMethod = QtGui.QComboBox(self.layoutWidget5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ImagePhys_DisplayTraces = QtGui.QPushButton(self.layoutWidget5)
        ...
        self.ImagePhys_ExportTiff = QtGui.QPushButton(self.layoutWidget5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget6 = QtGui.QWidget(self.groupBox_5)
        self.layoutWidget6.setGeometry(QtCore.QRect(5, 20, 96, 64))
        ...
        self.ImagePhys_PhysROIPlot = QtGui.QCheckBox(self.layoutWidget6)
        ...
        self.ImagePhys_RectSelect = QtGui.QCheckBox(self.layoutWidget6)
        ...
        self.ImagePhys_CorrTool_BL1 = QtGui.QCheckBox(self.layoutWidget6)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget7 = QtGui.QWidget(self.ImagePhys_FileGroup)
        self.layoutWidget7.setGeometry(QtCore.QRect(5, 65, 158, 26))
        ...
        self.ImagePhys_DataStruct = QtGui.QComboBox(self.layoutWidget7)
        ...
        self.layoutWidget8 = QtGui.QWidget(self.ImagePhys_FileGroup)
        self.layoutWidget8.setGeometry(QtCore.QRect(5, 115, 131, 27))
        ...
        self.ImagePhys_ignoreFirst = QtGui.QSpinBox(self.layoutWidget8)
        ...
        self.layoutWidget9 = QtGui.QWidget(self.ImagePhys_FileGroup)
        self.layoutWidget9.setGeometry(QtCore.QRect(5, 90, 164, 28))
        ...
        self.label_2 = QtGui.QLabel(self.layoutWidget9)
        self.label_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.horizontalLayout_5.addWidget(self.label_2)
        self.ImagePhys_Downsample = QtGui.QComboBox(self.layoutWidget9)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lucida Grande"))
        ...
        self.layoutWidget10.setGeometry(QtCore.QRect(0, 40, 116, 32))
        ...
        self.ImagePhys_UnBleach = QtGui.QPushButton(self.layoutWidget10)
        ...
        self.ImagePhys_BleachInfo = QtGui.QLabel(self.layoutWidget10)
        ...
        self.layoutWidget11.setGeometry(QtCore.QRect(0, 95, 119, 27))
        ...
        self.ImagePhys_SpecHPF = QtGui.QDoubleSpinBox(self.layoutWidget11)
        ...
        self.layoutWidget12.setGeometry(QtCore.QRect(0, 125, 119, 27))
        self.layoutWidget12.setObjectName(_fromUtf8("layoutWidget12"))
        self.horizontalLayout_11 = QtGui.QHBoxLayout(self.layoutWidget12)
        self.horizontalLayout_11.setMargin(0)
        self.horizontalLayout_11.setObjectName(_fromUtf8("horizontalLayout_11"))
        self.label_8 = QtGui.QLabel(self.layoutWidget12)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.horizontalLayout_11.addWidget(self.label_8)
        self.ImagePhys_SpecLPF = QtGui.QDoubleSpinBox(self.layoutWidget12)
        ...
        self.layoutWidget13 = QtGui.QWidget(self.groupBox_2)
        self.layoutWidget13.setGeometry(QtCore.QRect(1, 155, 149, 27))
        self.layoutWidget13.setObjectName(_fromUtf8("layoutWidget13"))
        self.horizontalLayout_12 = QtGui.QHBoxLayout(self.layoutWidget13)
        self.horizontalLayout_12.setMargin(0)
        self.horizontalLayout_12.setObjectName(_fromUtf8("horizontalLayout_12"))
        self.label_10 = QtGui.QLabel(self.layoutWidget13)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.horizontalLayout_12.addWidget(self.label_10)
        self.ImagePhys_FFTSmooth = QtGui.QSpinBox(self.layoutWidget13)
        ...
        self.layoutWidget14.setGeometry(QtCore.QRect(5, 55, 136, 27))
        self.layoutWidget14.setObjectName(_fromUtf8("layoutWidget14"))
        self.horizontalLayout_7 = QtGui.QHBoxLayout(self.layoutWidget14)
        self.horizontalLayout_7.setMargin(0)
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.label_3 = QtGui.QLabel(self.layoutWidget14)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.horizontalLayout_7.addWidget(self.label_3)
        self.ImagePhys_BaseEnd = QtGui.QDoubleSpinBox(self.layoutWidget14)
        ...
        self.layoutWidget15 = QtGui.QWidget(self.groupBox_6)
        self.layoutWidget15.setGeometry(QtCore.QRect(5, 20, 136, 27))
        self.layoutWidget15.setObjectName(_fromUtf8("layoutWidget15"))
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.layoutWidget15)
        self.horizontalLayout_2.setMargin(0)
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.label = QtGui.QLabel(self.layoutWidget15)
        self.label.setObjectName(_fromUtf8("label"))
        self.horizontalLayout_2.addWidget(self.label)
        self.ImagePhys_BaseStart = QtGui.QDoubleSpinBox(self.layoutWidget15)
        ...
        self.layoutWidget16 = QtGui.QWidget(self.groupBox_6)
        self.layoutWidget16.setGeometry(QtCore.QRect(5, 85, 136, 32))
        self.layoutWidget16.setObjectName(_fromUtf8("layoutWidget16"))
        self.horizontalLayout_8 = QtGui.QHBoxLayout(self.layoutWidget16)
        self.horizontalLayout_8.setMargin(0)
        self.horizontalLayout_8.setObjectName(_fromUtf8("horizontalLayout_8"))
        self.ImagePhys_CorrTool_LPF = QtGui.QCheckBox(self.layoutWidget16)
        ...
        self.ImagePhys_ImgLPF = QtGui.QDoubleSpinBox(self.layoutWidget16)
        ...
        self.layoutWidget17 = QtGui.QWidget(self.groupBox_6)
        self.layoutWidget17.setGeometry(QtCore.QRect(5, 120, 136, 32))
        self.layoutWidget17.setObjectName(_fromUtf8("layoutWidget17"))
        self.horizontalLayout_9 = QtGui.QHBoxLayout(self.layoutWidget17)
        self.horizontalLayout_9.setMargin(0)
        self.horizontalLayout_9.setObjectName(_fromUtf8("horizontalLayout_9"))
        self.ImagePhys_CorrTool_HPF = QtGui.QCheckBox(self.layoutWidget17)
        ...
        self.ImagePhys_ImgHPF = QtGui.QDoubleSpinBox(self.layoutWidget17)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(QtGui.QApplication.translate("Form", "Base1(s)", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("Form", "Base0(s)", None, QtGui.QApplication.UnicodeUTF8))
