...
class DataManager2(Module):
    def __init__(self, manager, name, config):
        ...
        QtCore.QObject.connect(self.ui.fileTreeWidget, QtCore.SIGNAL('selectionChanged()'), self.fileSelectionChanged)
    ...
    def newFolder(self):
        ...
        if ftype == 'Folder':
            ...
            self.ui.fileTreeWidget.edit(item)
        else:
