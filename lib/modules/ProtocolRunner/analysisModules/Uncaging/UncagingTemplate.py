...
#
# Created: Thu Aug 27 16:20:26 2009
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.alphaSlider.setProperty("value", QtCore.QVariant(150))
        self.alphaSlider.setOrientation(QtCore.Qt.Horizontal)
        self.alphaSlider.setObjectName("alphaSlider")
        self.gridLayout.addWidget(self.alphaSlider, 6, 1, 1, 2)
        self.cameraDevCombo = QtGui.QComboBox(Form)
        self.cameraDevCombo.setObjectName("cameraDevCombo")
        self.gridLayout.addWidget(self.cameraDevCombo, 3, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.frame1Spin, 7, 1, 1, 1)
        ...
        self.clampTestStartSpin.setProperty("value", QtCore.QVariant(400.0))
        ...
        self.clampTestStopSpin.setProperty("value", QtCore.QVariant(450.0))
        ...
        self.clampBaseStopSpin.setProperty("value", QtCore.QVariant(380.0))
        ...
        self.pspToleranceSpin.setProperty("value", QtCore.QVariant(4.0))
        ...
        self.spotToleranceSpin.setProperty("value", QtCore.QVariant(0.5))
        self.spotToleranceSpin.setObjectName("spotToleranceSpin")
        self.gridLayout.addWidget(self.spotToleranceSpin, 11, 1, 1, 2)
        self.recomputeBtn = QtGui.QPushButton(Form)
        self.recomputeBtn.setObjectName("recomputeBtn")
        self.gridLayout.addWidget(self.recomputeBtn, 12, 1, 1, 1)
        self.frame2Spin = QtGui.QSpinBox(Form)
        self.frame2Spin.setObjectName("frame2Spin")
        self.gridLayout.addWidget(self.frame2Spin, 7, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(QtGui.QApplication.translate("Form", "Camera Device", None, QtGui.QApplication.UnicodeUTF8))
