...
#
# Created: Mon Aug 10 17:54:20 2009
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.xAutoPercentSpin.setEnabled(False)
        ...
        self.yAutoPercentSpin.setEnabled(False)
        ...
        self.alphaGroup = QtGui.QGroupBox(self.tab_2)
        self.alphaGroup.setCheckable(True)
        self.alphaGroup.setObjectName("alphaGroup")
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.alphaGroup)
        ...
        self.verticalLayout_3.addWidget(self.autoAlphaCheck)
        self.alphaSlider = QtGui.QSlider(self.alphaGroup)
        self.alphaSlider.setMaximum(100)
        self.alphaSlider.setProperty("value", QtCore.QVariant(100))
        self.alphaSlider.setOrientation(QtCore.Qt.Horizontal)
        self.alphaSlider.setObjectName("alphaSlider")
        self.verticalLayout_3.addWidget(self.alphaSlider)
        self.verticalLayout_2.addWidget(self.alphaGroup)
        ...
        spacerItem = QtGui.QSpacerItem(59, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        spacerItem2 = QtGui.QSpacerItem(20, 211, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
