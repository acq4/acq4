...
#
# Created: Thu Jan 20 16:30:01 2011
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.queryText, 3, 0, 1, 1)
        self.queryBtn = QtGui.QPushButton(Form)
        self.queryBtn.setObjectName("queryBtn")
        self.gridLayout_2.addWidget(self.queryBtn, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.queryTable, 4, 0, 1, 2)
        self.storeBtn = FeedbackButton(Form)
        self.storeBtn.setObjectName("storeBtn")
        self.gridLayout_2.addWidget(self.storeBtn, 2, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.storeBtn.setText(QtGui.QApplication.translate("Form", "Store To DB", None, QtGui.QApplication.UnicodeUTF8))
