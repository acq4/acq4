...
class ObjTracker:
    ...
    def collect(self):
        ...
        gc.collect()
        objs = get_all_objects(useCache=False)
    ...
    def report(self, refs):
        allobjs = get_all_objects(useCache=True)
        #typs = d.values()
