...
class EventFilter(CtrlNode):
    ...
    uiTemplate = [
        ...
        ('fitRiseTime', 'check', {'value': False}),
        ('minFitRiseTime', 'spin', {'value': 0, 'step': 1, 'minStep': 1e-4, 'range': [None,None], 'siPrefix': True, 'suffix': 's', 'hidden': True}),
        ('maxFitRiseTime', 'spin', {'value': 0, 'step': 1, 'minStep': 1e-4, 'range': [None,None], 'siPrefix': True, 'suffix': 's', 'hidden': True}),
        ('fitMaxRiseSlope', 'check', {'value': False}),
        ('minFitMaxRiseSlope', 'spin', {'value': 0, 'step': 1, 'minStep': 1e-10, 'range': [None,None], 'siPrefix': True, 'suffix': 'A/s', 'hidden': True}),
        ('maxFitMaxRiseSlope', 'spin', {'value': 0, 'step': 1, 'minStep': 1e-10, 'range': [None,None], 'siPrefix': True, 'suffix': 'A/s', 'hidden': True}),
