...
#
# Created: Mon Oct 31 10:41:21 2011
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.microscopeCombo.sizePolicy().hasHeightForWidth())
        self.microscopeCombo.setSizePolicy(sizePolicy)
